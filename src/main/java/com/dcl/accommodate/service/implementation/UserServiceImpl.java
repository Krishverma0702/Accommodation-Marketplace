...
public class UserServiceImpl implements UserService {
    ...
    public AuthResponse loginUser(UserLoginRequest request) {
        ...
        return new AuthResponse(
                user.getEmail(),
                jwtService.generateAccessToken(claims, user.getUserId().toString(), Duration.ofMinutes(15)),
                15,
                jwtService.generateRefreshToken(user.getUserId().toString(), Duration.ofHours(24)),
                24
        );
    }
